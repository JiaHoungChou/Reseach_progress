...
class ModelOptimization:
    ...
    def OptimizationProcessMainRun(self, ParamBounds, OptMaxiter, Visualization= True):
        ...
        if Visualization!= False:
            ...
            plt.plot(np.arange(0, len(MutipleStepsRollingPredictionResults)), MutipleStepsRollingPredictionResults, label= "mutistep-ahead rolling predicted SOH")
            plt.plot(np.arange(0, len(self.SingleVariateTrainX)), self.SingleVariateTrainX, label= "actual SOH")
...
if __name__ == "__main__":
    ...
    OptXTimeStamps= 7; OptYtimeStamps= 1; OptBatchSize= 77; Epoch= 10000; LearningRate= 0.01; EarlyStopEpoch= 10
    ...
    if ModelOptimizationProcess== True:
        ...
        plt.figure(figsize= (10, 4))
        plt.plot(np.arange(0, len(ModelOptimizaionModule.OptimizationLoss)), ModelOptimizaionModule.OptimizationLoss, label= "DE optimization loss curve", color= "darkblue")
        plt.scatter(Bnp.arange(0, len(ModelOptimizaionModule.OptimizationLoss)), ModelOptimizaionModule.OptimizationLoss, color= "darkblue", edgecolors= "black", s= 50)
        plt.grid(True)
        plt.xticks(fontsize= 20)
        plt.yticks(fontsize= 20)
        plt.xlabel("Cycle", fontsize= 20)
